...
def deconv2d(input_, output_shape, is_train,
             k=5, s=2, stddev=0.01, activation_fn='relu', padding='SAME',
    ...
    with tf.variable_scope(name):
        ...
        elif activation_fn is 'tanh':
            deconv = tf.nn.tanh(deconv, name='tanh')
        elif activation_fn is 'sigmoid':
            deconv = tf.nn.sigmoid(deconv, name='sigmoid')
        else:
...
def deconv3d(input_, output_shape, is_train,
             k, s, stddev=0.01, activation_fn='relu', padding='SAME',
